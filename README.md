...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybloom_live-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7510&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybloom_live-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybloom_live` can be installed with:

```
conda install pybloom_live
```

It is possible to list all of the versions of `pybloom_live` available on your platform with:
